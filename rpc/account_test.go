...
const testAccount = "cga_1zcffp784drsmz4oksufxfjut1nb5yh6pg43a6h6bkos39zz19ed6a4r36ny"

func getClient() *rpc.Client {
	return &rpc.Client{URL: "http://[::1]:7132"}
}
...
func TestAccountHistoryRaw(t *testing.T) {
	...
	assert.Equal(t, "cga_1natrium1o3z5519ifou7xii8crpxpk8y65qmkih8e8bpsjri651oza8imdd", h.Representative)
...
func TestAccountRepresentative(t *testing.T) {
	...
	require.Nil(t, err)
	assert.Equal(t, "cga_1natrium1o3z5519ifou7xii8crpxpk8y65qmkih8e8bpsjri651oza8imdd", representative)
}
...
func TestAccountsPending(t *testing.T) {
	pendings, err := getClient().AccountsPending([]string{
		testAccount, "cga_159m8t4iedstzcaacikb9hdkhbcxcqzfbw56dutay8ceqagq9wxpsk9ftfq9"}, 1)
	require.Nil(t, err)
	require.Len(t, pendings, 2)
	assert.Empty(t, pendings[testAccount])
	blocks := pendings["cga_159m8t4iedstzcaacikb9hdkhbcxcqzfbw56dutay8ceqagq9wxpsk9ftfq9"]
	...
	assert.Equal(t, "cga_3kwppxjcggzs65fjh771ch6dbuic3xthsn5wsg6i5537jacw7m493ra8574x", pending.Source)
}
