...
func TestAddressToPubkey(t *testing.T) {
	pubkey, err := util.AddressToPubkey("cga_1e5aqegc1jb7qe964u4adzmcezyo6o146zb8hm6dft8tkp79za3sxwjym5rx")
	require.Nil(t, err)
...
func TestPubkeyToAddress(t *testing.T) {
	...
	require.Nil(t, err)
	assert.Equal(t, "cga_1e5aqegc1jb7qe964u4adzmcezyo6o146zb8hm6dft8tkp79za3sxwjym5rx", address)
}
